...
class GameFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        Log.i("GameFragment", "Call ViewModelProviders to get GameView Model")
        ...
        /*   XML directly access viewModel to perform on click
        ...
        */
        ...
        /** Methods for auto updating the UI **/
        /*   // No need to observe if we use the databinding. it does the job for us
